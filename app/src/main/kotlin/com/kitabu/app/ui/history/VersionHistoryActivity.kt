...
class VersionHistoryActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        vm.getVersions(noteId).observe(this) { adapter.submitList(it) }
    }
...
class VersionAdapter(private val onClick: (NoteVersion) -> Unit) :
    ...
    override fun onBindViewHolder(h: VH, pos: Int) {
        ...
        h.b.tvVersionPreview.text = v.content.take(120)
        h.b.root.setOnClickListener { onClick(v) }
    }
}
