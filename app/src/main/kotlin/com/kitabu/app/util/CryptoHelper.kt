...
object CryptoHelper {
    ...
    fun decrypt(ciphertext: String): String? {
        ...
        if (!isEncrypted(ciphertext)) return ciphertext  // Not encrypted — backward compat
        return try {
            val key = getOrCreateSecretKey()
            ...
            // Decryption failed (key may have been reset) — return null so caller can handle it
            null
        }
    }
