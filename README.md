...
- Smart note templates (journal, meeting, tasks, writing)
- Checklist progress insights in library and editor
- Keyboard shortcuts for power users (new/search/preview)
